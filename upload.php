...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; text-decoration: none; }
        ...
        .card-upload h2 {
            font-family: 'Poppins', serif; color: white; font-size: 26px;
            margin-bottom: 25px; text-align: center;
        }

        .form-group { margin-bottom: 20px; }
        .form-group label {
            display: block; font-weight: 500; margin-bottom: 8px; font-size: 15px; color: #1a2e35;
        }
        ...
        .small-note {
            font-size: 12px; color: #1a2e35; margin-top: 5px; display: block;
        }
...
<body>
        ...
        <div class="card-upload">
            ...
            <form action="" method="POST">
                ...
                <div class="button-group">
                    <button type="submit" name="simpan" class="btn btn-simpan">Upload</button>
                </div>
    ...
    <div class="modal-overlay modal-show">
        <div class="modal-box">
            ...
            <p class="modal-desc">Sipp sudah terupload</p>
